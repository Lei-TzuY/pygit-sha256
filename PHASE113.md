# Phase 113 — pack-refs include/exclude patterns

Phase 113 extends the existing packed-reference backend with Git-style pattern selection for `pack-refs`.
