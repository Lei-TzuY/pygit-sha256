# Phase 63: pack import plumbing

Phase 63 adds low-level import operations for pygit's native SHA-256 pack format. It complements the existing `repack`, `verify-pack`, `count-objects`, and `fsck` commands with the inverse operations needed to reconstruct an index or materialize packed objects as loose storage.
