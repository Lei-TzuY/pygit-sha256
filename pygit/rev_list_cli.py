"""CLI adapter for advanced ``rev-list`` commit-set traversal."""
...
def run_rev_list(argv: Sequence[str]) -> int:
    parser = argparse.ArgumentParser(
        prog="pygit rev-list",
        description="List commits reachable from revision sets without touching repository state.",
    )
    ...
    parser.add_argument("--reverse", action="store_true", help="reverse the final selected output order")
