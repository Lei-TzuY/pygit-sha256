"""Phase 65 tests: read-only smart-HTTP remote ref inspection."""
...
def test_ls_remote_filters_heads_tags_refs_and_tail_patterns(monkeypatch) -> None:
    ...
    heads_and_tags = ls_remote(URL, heads=True, tags=True)
    assert [ref.name for ref in heads_and_tags.refs] == [
        "refs/heads/feature",
        "refs/heads/main",
        "refs/tags/v1.0",
        "refs/tags/v1.0^{}",
